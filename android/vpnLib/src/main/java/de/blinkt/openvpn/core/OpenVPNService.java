...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private void startOpenVPN() {
        ...
        // Fix incorrect folder name returned by Android
//        if (nativeLibraryDirectory.endsWith("/arm64")) {
//            nativeLibraryDirectory = nativeLibraryDirectory.replace("/arm64", "/arm64-v8a");
//
//        }
